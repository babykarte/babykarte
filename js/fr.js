var refFr = {"site-map": {
	...
	"MENUBUTTONS": {
		"btn_info": "Ouvrir l'aide",
		"btn_lang": "Choisir la langue",
		"btn_search": "Sélectionner un lieu",
	...
	"MAP_MARKERDOTS": {
		...
		"rating-yellow": "Ce lieu est provisoirement adapté aux bébés. ",
		"rating-red": "Ce lieu n'est pas adapté aux bébés. ",
	},
	"PDV_ICONS_EXPLANATION_GENERAL": "Les icônes ont différentes couleurs (vert : disponible/possible, jaune : Disponibilité limitée, rouge : non disponible/pas possible, gris : inconnu)",
	"PDV_ICONS_EXPLANATION": {
		"PDV_ICON_CHANGINGTABLE": "<img class='small-icon' src='images/changingtable.svg' style='margin:0px;' /> État des installations de la table à langer",
		"PDV_ICON_HIGHCHAIR": "<img class='small-icon' src='images/highchair.svg' style='margin:0px;' /> État des chaises hautes",
		"PDV_ICON_STROLLER": "<img class='small-icon' src='images/stroller.svg' style='margin:0px;' /> État de l'adaptabilité aux poussettes",
		"PDV_ICON_BALL": "<img class='small-icon' src='images/ball.svg' style='margin:0px;' /> État de l'espace enfant",
		"PDV_ICON_BREASTFEEDING": "<span class='small-icon' style='margin:0px;'>&#129329;</span> Allaitement autorisé/interdit",
	...
	"PDV_HIGHCHAIR_COUNT": "chaises hautes",
